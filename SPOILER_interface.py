...
class Application(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Generateur de RAT - Interface Professionnelle")
        self.geometry("650x650")  # Taille augmentee pour plus d'espace visuel
...
class FileSelectionPage(CenteredFrame):
    def __init__(self, parent, controller):
        ...
        ctk.CTkLabel(self.inner_frame, text="Selectionner un fichier pour l'injection",
                     font=("Arial", 24, "bold"), text_color="lightblue").pack(pady=20)

        self.file_label = ctk.CTkLabel(self.inner_frame, text="Aucun fichier selectionne",
...
class WaitingPage(CenteredFrame):
    def __init__(self, parent, controller):
        ...
        self.animation_label = ctk.CTkLabel(self.inner_frame, text="",
                                            font=("Arial", 30,"bold"), text_color="lightblue")
    ...
    def animate_points(self):
        """Animation de points (...)"""
        dots = itertools.cycle(["Veuillez patienter", "Veuillez patienter.", "Veuillez patienter..", "Veuillez patienter..."])
        while self.running:
    ...
    def on_show(self):
        """Reprendre l'animation quand la page est affichee."""
        self.running = True
